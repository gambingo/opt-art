...
class Optimize():
    ...
    from ._plotting_tools import plot_path, plot_graph
    from ._plotting_tools import plot_convergence, plot_greediness
    from ._plotting_tools import plot_unique_paths